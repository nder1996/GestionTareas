...
namespace gestion_tareas.DBContext
{
    public class TareasDbContext : Microsoft.EntityFrameworkCore.DbContext // Cambiar nombre y heredar
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TareaXAuditoria>(entity =>
            {
            ...
            modelBuilder.Entity<TareaXAuditoria>().HasData(
                ...
                { 
                    Id = 1,
                    Tarea = new Tarea { Id = 1 },
                    Auditoria = new Auditoria { Id = 1 },
                    create_at = new DateTime(2025, 3, 1)
                },
                new TareaXAuditoria
                {
                    Id = 2,
                    Tarea = new Tarea { Id = 2 },
                    Auditoria = new Auditoria { Id = 2 },
                    create_at = new DateTime(2025, 3, 5)
                },
                new TareaXAuditoria
                {
                    Id = 3,
                    Tarea = new Tarea { Id = 3 },
                    Auditoria = new Auditoria { Id = 3 },
                    create_at = new DateTime(2025, 3, 12)
                }
            );

            modelBuilder.Entity<TareaXAuditoria>()
                .Navigation(t => t.Auditoria)
                .AutoInclude();

            modelBuilder.Entity<TareaXAuditoria>()
                .Navigation(t => t.Tarea)
                .AutoInclude();
        }
    }
}
